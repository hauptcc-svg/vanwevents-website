...
export default function EnquiryForm() {
  ...
  return (
    <section id="enquiry" className="bg-[#001A4D] py-24 px-6 lg:px-8 relative overflow-hidden">
      {/* Background texture */}
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-white/60 font-sans text-base leading-relaxed mb-8">
              Complete the form and our team will reach out within{" "}
              <span className="text-[#C9A84C]">24 hours</span> with personalised
              pricing and availability — no commitment required.
            </p>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-white/60 font-sans text-sm leading-relaxed max-w-xs">
                    Thank you! Our team will be in touch within{" "}
                    <span className="text-[#C9A84C]">24 hours</span> with
                    personalised pricing and availability.
                  </p>
                  <div className="mt-6 w-12 h-px bg-[#C9A84C]/40 mx-auto" />
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      {...register("message")}
                      rows={4}
                      placeholder="Tell us about your dream cruise experience, any special requirements, preferred dates…"
